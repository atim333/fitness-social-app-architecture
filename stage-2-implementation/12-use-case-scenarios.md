...
## Архитектурные гарантии отказоустойчивости

**Критические сценарии и обработка ошибок:**
- **Платежи и бронирование (UC-3, UC-4):** Circuit Breaker (5 ошибок/60с) + 2 retry + fallback на альтернативные провайдеры
- **Массовые операции (UC-6, UC-10):** Батчевая обработка + Rate limiting (1000/10с) + Eventual consistency лидербордов ≤5с
- **Асинхронные гарантии:** Kafka с DLQ после 3 попыток (30s, 2m, 5m) + автоматический откат через компенсирующие транзакции

**Мониторинг:**
- **Алерты:** Circuit Breaker OPEN >5мин, DLQ >50 сообщений, RPS >10,000
- **SLO:** Конверсия оплаты 95%, MTTR <10мин
- **Fallback-стратегии:** Отложенная оплата, резервные регионы, кешированные данные

**Технические паттерны:** Circuit Breaker, Exponential Backoff, Dead Letter Queue, Compensating Transactions
